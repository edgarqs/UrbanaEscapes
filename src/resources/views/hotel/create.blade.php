            ...
            <div class="form-row d-flex">
                <div class="form-group flex-fill mr-3">
                    ...
                    <input type="text" name="nom" id="nom" class="form-control @error('nom') is-invalid @enderror"
                        value="{{ old('nom') }}" minlength="5" maxlength="30" required>
                    @error('nom')
            ...
            <div class="form-row d-flex">
                <div class="form-group flex-fill">
                    ...
                    <input type="text" name="adreca" id="adreca"
                        class="form-control @error('adreca') is-invalid @enderror" value="{{ old('adreca') }}"
            ...
            <div class="form-row d-flex">
                <div class="form-group flex-fill mr-3">
                    ...
                    <input type="text" name="ciutat" id="ciutat"
                        class="form-control @error('ciutat') is-invalid @enderror" value="{{ old('ciutat') }}"
                ...
                <div class="form-group flex-fill">
                    ...
                    <input type="text" name="pais" id="pais"
                        class="form-control @error('pais') is-invalid @enderror" value="{{ old('pais') }}" maxlength="23"
                        required>
                    @error('pais')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
            ...
            <div class="form-row d-flex">
                <div class="form-group flex-fill">
                    ...
                    <input type="tel" name="telefon" id="telefon"
                        class="form-control @error('telefon') is-invalid @enderror" value="{{ old('telefon') }}"
        ...
        <form id="form-step-2-fields" action="{{ route('hotel.store') }}" method="post">
            ...
            <div class="form-row d-flex">
                <div class="form-group flex-fill">
                    ...
                    <input type="number" name="habitacions" id="habitacions"
                        ...
                        value="{{ old('habitacions', 100) }}" min="0"
                        placeholder="Quantes habitacions vols crear?" required>
                    @error('habitacions')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-row d-flex">
                <div class="form-group flex-fill">
                    ...
                    <input type="number" name="feedbacks" id="feedbacks"
                        class="form-control @error('feedbacks') is-invalid @enderror" value="{{ old('feedbacks', 10) }}"
                        min="0" placeholder="Quants feedbacks vols crear?" required>
                    @error('feedbacks')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
