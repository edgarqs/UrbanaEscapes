<template>
    <header class="bg-gray-50 shadow-md">
      <nav class="max-w-7xl mx-auto flex items-center justify-between p-4">
        ...
        <div class="flex items-center">
          <a href="#" class="text-xl font-bold text-gray-800">
            <img src="../public/urbana_logo.svg" alt="logo urbana escapes" class="h-8">
          </a>
        </div>
        ...
        <div class="flex items-center space-x-6">
          ...
          <div class="relative">
            ...
            >
              ...
              <span class="hidden lg:inline">{{ currentLanguage.label }}</span>
            ...
            >
              ...
              >
                ...
                <span class="hidden lg:block">{{ lang.label }}</span>
              </button>
            </div>
          </div>
        </div>
      ...
      <div v-if="menuOpen" class="flex flex-col items-start bg-white shadow-md lg:hidden p-4 space-y-3">
        <a href="#" class="text-gray-600 hover:text-gray-800 px-3 py-1 rounded-full hover:bg-gray-100 transition duration-300">Home</a>
        <a href="#" class="text-gray-600 hover:text-gray-800 px-3 py-1 rounded-full hover:bg-gray-100 transition duration-300">About</a>
        <a href="#" class="text-gray-600 hover:text-gray-800 px-3 py-1 rounded-full hover:bg-gray-100 transition duration-300">Services</a>
        <a href="#" class="text-gray-600 hover:text-gray-800 px-3 py-1 rounded-full hover:bg-gray-100 transition duration-300">Contact</a>
      </div>
    </header>
  </template>
