...
<template>
    <div>
        ...
        <div class="container mx-auto p-4">
            <div v-for="(habitacions, hotelId) in groupedHabitacions" :key="hotelId"
                ...
                <div class="mb-4">
                    ...
                    <p class="text-sm text-gray-600">{{ habitacions[0].hotel.adreca }}, {{ habitacions[0].hotel.ciutat
                        }}, {{ habitacions[0].hotel.pais }}</p>
                </div>
                <div class="w-full flex flex-wrap gap-6">
                    <div v-for="habitacio in habitacions" :key="habitacio.id"
                        ...
                        <div class="flex-shrink-0 w-1/3 h-56 overflow-hidden">
                            ...
                            <img :src="getImageForRoomType(habitacio.tipus)" :alt="`Habitación ${habitacio.id}`"
                        ...
                        <div class="p-4 flex flex-col justify-between w-2/3">
                            ...
                            <p class="text-sm text-gray-700"><strong>Descripció: </strong>Habitació {{ habitacio.tipus
                                }} amb {{ habitacio.llits }} llits y {{ habitacio.llits_supletoris }} llits
                                supletoris.<span v-if="habitacio.id % 2 === 0"> Balconada amb vistes exteriors.</span>
                            </p>
                            <p class="text-sm text-gray-700"><strong>Capacitat:</strong> {{ habitacio.llits +
